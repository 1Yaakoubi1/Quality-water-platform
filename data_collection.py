...
def get_data(long, lat, start_date, end_date):
  ...
  geemap.ee_export_image(
      ndwi,                            # ndwi, ddddddddddddddddddddddddddddddd
      filename='TUNISIE.tif', # your desired output name
      scale=10,
      region=geometry.buffer(1000).bounds().getInfo(), # slightly buffered region around your point
      file_per_band=False
  )
